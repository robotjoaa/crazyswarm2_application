...
from smaclike.mamp.util import pi_2_pi, l3norm
from smaclike.mamp.policies.kdTree import KDTree
from smaclike.mamp.configs.config import NEAR_GOAL_THRESHOLD
...
class MACAEnv(object):
    ...
    def set_agents(self, agents, obstacles):
        self.agents = agents
        self.obstacles = obstacles
        self.kdTree = KDTree(self.agents, self.obstacles)
        self.kdTree.buildObstacleTree()
    
    def updateAgents(self, new_agents) : 
        self.agents = new_agents
        self.kdTree.updateAgentTree(new_agents)
